...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        balancaFilizola.exportar(produtos, "C:/Users/Alex F/Downloads/teste");

        IBalanca balancaToledo = BalancaFactory.getBalanca(TipoBalanca.TOLEDO_MGV6);
        balancaToledo.exportar(produtos, "C:/Users/Alex F/Downloads/teste");

        IBalanca balancaUrano = BalancaFactory.getBalanca(TipoBalanca.URANO_INTEGRA);
        balancaUrano.exportar(produtos, "C:/Users/Alex F/Downloads/teste");
